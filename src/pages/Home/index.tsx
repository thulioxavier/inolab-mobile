            ...
            <S.Container>
                ...
                <S.Content>
                    ...
                    <S.CardAnswer style={S.Styles.Shadow}>
                        <S.HeaderCardAnswer>
                            <S.HeaderText>Data: {`${selectedDay < 10 ? '0' + selectedDay : selectedDay}/${Number(selectedMonth + 1) < 10 ? '0' + (selectedMonth + 1) : (selectedMonth + 1)}/${new Date().getFullYear()}`}</S.HeaderText>
                        </S.HeaderCardAnswer>
                        <S.BodyCardAnswer>
                            <S.AreaText>
